...
// Cropped to just the circular mark from public/assets/images/logo-nei-noText.svg
// (that file's viewBox is 317x82, the full "nei" wordmark) - this is only the
// first, self-contained path, i.e. the icon without the lettering next to it.
const NeiIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg
    viewBox="0 0 85 83"
    fill="none"
...
const AuthNeiButton: React.FC<AuthNeiButtonProps> = ({
  ...
  return (
    ...
    >
      <NeiIcon className="size-5 shrink-0" />
